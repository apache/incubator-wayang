...
public class Conv2D extends Conv {
    ...
    public Conv2D(int inChannels, int outChannels, int[] kernelSize, int[] stride, String padding, boolean bias, String name) {
        this(inChannels, outChannels, kernelSize, stride, padding, bias, name, DType.FLOAT32);
    }

    public Conv2D(int inChannels, int outChannels, int[] kernelSize, int[] stride, String padding, boolean bias, DType dType) {
        this(inChannels, outChannels, kernelSize, stride, padding, bias, null, dType);
    }

    public Conv2D(int inChannels, int outChannels, int[] kernelSize, int[] stride, String padding, boolean bias, String name, DType dType) {
