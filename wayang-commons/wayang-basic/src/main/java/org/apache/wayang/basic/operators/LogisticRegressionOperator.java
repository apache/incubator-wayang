...
public class LogisticRegressionOperator extends BinaryToUnaryOperator<double[], Double, LogisticRegressionModel> {

    protected boolean fitIntercept;

    public LogisticRegressionOperator(boolean fitIntercept) {
        super(
                DataSetType.createDefaultUnchecked(double[].class),
                DataSetType.createDefaultUnchecked(Double.class),
                DataSetType.createDefaultUnchecked(LogisticRegressionModel.class),
                false
        );
        this.fitIntercept = fitIntercept;
    }

    public LogisticRegressionOperator(LogisticRegressionOperator that) {
        super(that);
