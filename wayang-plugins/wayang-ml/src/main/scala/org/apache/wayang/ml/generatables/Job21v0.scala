 ...
 */
 ...
 class Job21v0 extends GeneratableJob {
...
val group9 = map10.reduceByKey(_._2, (t1,t2) => t1)
...
val join7 = join5.keyBy[Long](_._4).join(map8.keyBy[Long](_._1)).map(x => x.field1)
       

val group12 = join7.reduceByKey(_._2, (t1,t2) => t1)
