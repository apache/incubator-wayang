...
public class Udf {
    ...
    /**
     * Fetches the {@link UDFComplexity} of an operator given that the {@link FunctionDescriptor} has been supplied with a {@link UDFComplexity}.
     * If an operator has multiple descriptors, it returns whichever Big-O complexity is not within the other.
     * @param operator
     * @return {@link UDFComplexity} either {@link UDFComplexity#LOGARITHMIC}, {@link UDFComplexity#LINEAR}, {@link UDFComplexity#QUADRATIC} or {@link UDFComplexity#SUPERQUADRATIC}.
     */
