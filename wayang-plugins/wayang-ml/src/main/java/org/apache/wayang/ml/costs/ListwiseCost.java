...
public class ListwiseCost implements EstimatableCost {
...
public static class Factory implements EstimatableCostFactory {
    ...
    public PlanImplementation pickBestExecutionPlan(
        ...
        // Call the model with all encoded plans and compare
        // Use the retrieved ranking to pick the best one
