...
public class Query2 {
    ...
    public static WayangPlan getWayangPlan(String dataPath, Collection<LtMlTMkKMcCtCn> collector){
        ...
        JoinOperator<Tuple2<LtMlTMkKMcCt, CompanyName>, CompanyName, String> cnSelfJoin =
        ...
        ReduceByOperator<LtMlTMkKMcCtCn, String> cnMin =
        ...
        ReduceByOperator<LtMlTMkKMcCtCn, String> ltMin =
                new ReduceByOperator<>(
        ...
        ReduceByOperator<LtMlTMkKMcCtCn, String> tMin =
                new ReduceByOperator<>(
        ...
        LocalCallbackSink<LtMlTMkKMcCtCn> sink =
    ...
    private static class LtMlTMkKMcCt extends Tuple2<Tuple2<
            Tuple2<Tuple2<Tuple2<Tuple2<LinkType, MovieLink>, Title>, MovieKeyword>, Keyword>,
            MovieCompanies>, CompanyType> {}

    private static class LtMlTMkKMcCtCn extends Tuple2<LtMlTMkKMcCt, CompanyName> {}
}
