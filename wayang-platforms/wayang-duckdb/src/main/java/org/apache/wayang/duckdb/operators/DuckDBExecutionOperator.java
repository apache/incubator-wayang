...
/**
 * Marker for {@link JdbcExecutionOperator}s that run on the {@link DuckDBPlatform}.
 */
public interface DuckDBExecutionOperator extends JdbcExecutionOperator {

    @Override
    default DuckDBPlatform getPlatform() {
