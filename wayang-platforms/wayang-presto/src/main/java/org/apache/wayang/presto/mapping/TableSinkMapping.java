...
import org.apache.wayang.presto.operators.PrestoTableSinkOperator;
...
/**
 * Maps a {@link TableSink} to a {@link PrestoTableSinkOperator}.
 */
...
public class TableSinkMapping implements Mapping {
    ...
    private ReplacementSubplanFactory createReplacementSubplanFactory() {
        return new ReplacementSubplanFactory.OfSingleOperators<TableSink>(
                (matchedOperator, epoch) -> new PrestoTableSinkOperator(matchedOperator).at(epoch)
        );
    }
}
