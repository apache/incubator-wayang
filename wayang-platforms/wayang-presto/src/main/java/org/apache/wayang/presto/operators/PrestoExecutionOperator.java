...
/**
 * Marker for {@link JdbcExecutionOperator}s that run on the {@link PrestoPlatform}.
 */
public interface PrestoExecutionOperator extends JdbcExecutionOperator {

    @Override
    default PrestoPlatform getPlatform() {
