...
public class JdbcExecutor extends ExecutorTemplate {
     ...
     * unless it is not comprising a {@link JdbcExecutionOperator}
     * and/or not in the given {@link ExecutionStage}.
     */
    ...
    protected static Tuple2<String, SqlQueryChannel.Instance> createSqlQuery(
        ...
        while (nextTask != null) {
            ...
            tipChannelInstance = JdbcExecutor.instantiateOutboundChannel(
                    nextTask,
                    context,
                    tipChannelInstance,
                    jdbcExecutor
