...
import org.apache.wayang.bigquery.operators.BigQueryTableSinkOperator;
...
/**
 * Mapping from {@link TableSink} to {@link BigQueryTableSinkOperator}.
 */
...
public class TableSinkMapping implements Mapping {
    ...
    private ReplacementSubplanFactory createReplacementSubplanFactory() {
        return new ReplacementSubplanFactory.OfSingleOperators<TableSink>(
                (matchedOperator, epoch) -> new BigQueryTableSinkOperator(matchedOperator).at(epoch));
    }
}
