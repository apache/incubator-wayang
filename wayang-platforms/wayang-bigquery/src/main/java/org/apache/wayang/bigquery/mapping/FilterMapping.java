...
import org.apache.wayang.bigquery.operators.BigQueryFilterOperator;
...
/**
 * Mapping from {@link FilterOperator} to {@link BigQueryFilterOperator}.
 */
...
public class FilterMapping implements Mapping {
    ...
    private ReplacementSubplanFactory createReplacementSubplanFactory() {
        return new ReplacementSubplanFactory.OfSingleOperators<FilterOperator>(
                (matchedOperator, epoch) -> new BigQueryFilterOperator(matchedOperator).at(epoch)
        );
    }
}
