...
public class Tuple3Serializer<A, B, C> extends Serializer<Tuple3<A, B, C>> {
    ...
    @Override
    public void write(Kryo kryo, Output output, Tuple3<A, B, C> object) {
    ...
    @Override
    public Tuple3<A, B, C> read(Kryo kryo, Input input, Class<Tuple3<A, B, C>> type) {
