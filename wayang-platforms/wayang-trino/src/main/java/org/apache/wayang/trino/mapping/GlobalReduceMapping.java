...
import org.apache.wayang.trino.operators.TrinoGlobalReduceOperator;
...
/**
 * Mapping from {@link GlobalReduceOperator} to {@link TrinoGlobalReduceOperator}.
 */
...
public class GlobalReduceMapping implements Mapping {
    ...
    private ReplacementSubplanFactory createReplacementSubplanFactory() {
        return new ReplacementSubplanFactory.OfSingleOperators<GlobalReduceOperator<Record>>(
                (matchedOperator, epoch) -> new TrinoGlobalReduceOperator(matchedOperator).at(epoch)
        );
    }
}
