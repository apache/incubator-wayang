...
import org.apache.wayang.trino.operators.TrinoTableSinkOperator;
...
/**
 * Mapping from {@link TableSink} to {@link TrinoTableSinkOperator}.
 */
...
public class TableSinkMapping implements Mapping {
    ...
    private ReplacementSubplanFactory createReplacementSubplanFactory() {
        return new ReplacementSubplanFactory.OfSingleOperators<TableSink>(
                (matchedOperator, epoch) -> new TrinoTableSinkOperator(matchedOperator).at(epoch)
        );
    }
}
