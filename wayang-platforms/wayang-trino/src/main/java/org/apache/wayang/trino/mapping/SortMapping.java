...
import org.apache.wayang.trino.operators.TrinoSortOperator;
...
/**
 * Mapping from {@link SortOperator} to {@link TrinoSortOperator}.
 */
...
public class SortMapping implements Mapping {
    ...
    private ReplacementSubplanFactory createReplacementSubplanFactory() {
        return new ReplacementSubplanFactory.OfSingleOperators<SortOperator<Record, Record>>(
                (matchedOperator, epoch) -> new TrinoSortOperator(matchedOperator).at(epoch)
        );
    }
}
