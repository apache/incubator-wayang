...
public class ReflectionUtilsTest {
    ...
    public void testEvaluateWithStaticVariable() {
        final Object val = ReflectionUtils.evaluate("io.rheem.rheem.core.util.ReflectionUtilsTest.TEST_INT");
        Assert.assertEquals(42, val);
    }

    @Test
    public void testEvaluateWithStaticMethod() {
        final Object val = ReflectionUtils.evaluate("io.rheem.rheem.core.util.ReflectionUtilsTest.testInt()");
