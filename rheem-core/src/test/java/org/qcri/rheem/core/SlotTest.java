...
public class SlotTest {
    ...
    public void testConnectMismatchingSlotFails() {
        TestSink<TestDataUnit> testSink = new TestSink<>(TestDataUnit.class);
        TestSource<TestDataUnit2> testSource = new TestSource<>(TestDataUnit2.class);
    ...
    public void testConnectMatchingSlots() {
        TestSink<TestDataUnit> testSink = new TestSink<>(TestDataUnit.class);
        TestSource<TestDataUnit> testSource = new TestSource<>(TestDataUnit.class);
        testSource.connectTo(0, testSink, 0);
    }
}
