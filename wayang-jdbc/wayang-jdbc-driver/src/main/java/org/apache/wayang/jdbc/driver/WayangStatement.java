...
class WayangStatement implements Statement {
    ...
    public ResultSet executeQuery(final String sql) throws SQLException {
        ...
        this.currentCursorId = response.getCursorId();
        this.currentResultSet = WayangResultSet.create(this, this.client, response, this.fetchSize, this.maxRows);
    ...
    public void cancel() throws SQLException {
        this.ensureOpen();
        if (this.currentCursorId != null) {
            final CancelQueryResponse response = this.client.cancelQuery(this.statementId, this.currentCursorId);
