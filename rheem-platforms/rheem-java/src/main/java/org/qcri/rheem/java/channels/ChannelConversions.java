...
public class ChannelConversions {
    ...
    public static final ChannelConversion STREAM_TO_COLLECTION = new DefaultChannelConversion(
            ...
            () -> new JavaCollectOperator<>(DataSetType.createDefault(Void.class)) // TODO
    );
    ...
    public static final ChannelConversion STREAM_TO_HDFS_OBJECT_FILE = new DefaultChannelConversion(
            ...
            () -> new JavaObjectFileSink<>(FileChannel.pickTempPath(), DataSetType.createDefault(Void.class)) // TODO
    );
    ...
    public static final ChannelConversion HDFS_OBJECT_FILE_TSV_TO_STREAM = new DefaultChannelConversion(
            FileChannel.HDFS_OBJECT_FILE_DESCRIPTOR,
            StreamChannel.DESCRIPTOR,
            () -> new JavaObjectFileSource<>(FileChannel.pickTempPath(), DataSetType.createDefault(Void.class)) // TODO
    );
    ...
    public static Collection<ChannelConversion> ALL = Arrays.asList(
            ...
            HDFS_TSV_TO_STREAM,
            HDFS_OBJECT_FILE_TSV_TO_STREAM
    );
}
