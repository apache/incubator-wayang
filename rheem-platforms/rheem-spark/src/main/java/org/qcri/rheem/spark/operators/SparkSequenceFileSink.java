 ...
 *
 * @see SparkSequenceFileSource
 */
public class SparkSequenceFileSink<T> extends UnarySink<T> implements SparkExecutionOperator {

    private final String targetPath;

    public SparkSequenceFileSink(String targetPath, DataSetType type) {
        super(type, null);
    ...
    public ExecutionOperator copy() {
        return new SparkSequenceFileSink<>(this.targetPath, this.getType());
    }
}
